...
// adc1_config_channel_atten(ADC1_CHANNEL_4,ADC_ATTEN_DB_11); // z coord
...
float is_brushing(int a, int b, int c) {
...
// if the is brushing function outputs a 1
 ...
 httpd_resp_send(req, "<head>"
                        ...
                        "<h1>Brushing Habits!</h1>"
                            ...
                            "</style>"                        
                        "<h2>Patient Name:_____</h2>"
                        "<h3>Patient Details</h3>"
                        "<h4>Patient Photograph</h4>"
                        "<h5>Patient's Brushing Habits</h5>"
                        "<ol>"
                        "<li>The person has brushed x times today</li>"
                        "<li>Tea</li>"
                        "<li>Milk</li>"
                        "</ol>"
                        "</body>", -1); // -1 = use strlen()
